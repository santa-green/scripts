DECLARE @ABDate SMALLDATETIME = '20180201',
		@AEDate SMALLDATETIME = '20180731',                                  
        @AOurs VARCHAR(1000) = '1-6,11',
        @ACodes1 VARCHAR(1000) = '2000-2005,2007-3001',
        @ACodes4 VARCHAR(1000) = '2000-2029,2100-5000',
        @ACodes5 VARCHAR(1000) = '2006,2007,2008,2010,2018,2022'
        
  SET NOCOUNT ON
    
  DECLARE
   @AMCount TINYINT, @AYearID SMALLINT, @ATotalText VARCHAR(100),
   @AMaxYearID SMALLINT, @AMonthID TINYINT, @ACodeID4 SMALLINT, @ACodeID2 SMALLINT     
  
     DECLARE 
     @Rep6_6 TABLE (CodeID4 SMALLINT, CodeID1 SMALLINT,YearID SMALLINT,
                    MonthID TINYINT,SumMC NUMERIC(21,9))
  
    INSERT INTO @Rep6_6  
    SELECT
     CodeID4, CodeID1, YearID, MonthID,
     SUM(SumMC) SumMC
    FROM (
          ...
          FROM t_Est m WITH(NOLOCK)
           ...
           JOIN r_StockGs rsg WITH(NOLOCK) ON rsg.StockGID = rs.StockGID
           ...
           JOIN r_Codes4 rc4 WITH(NOLOCK) ON rc4.CodeID4 = rsg.StockGID
           WHERE m.OurID IN (14,15,16)
             AND rpc.CodeID1 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes1,'r_Codes1'))
             AND rc4.CodeID4 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes4,'r_Codes4'))
             AND rpg1.CodeID5 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes5,'r_Codes5'))
             AND m.DocDate BETWEEN @ABDate AND @AEDate
           GROUP BY rc4.CodeID4,rpc.CodeID1,DocDate                
          ...
          WHERE m.OurID IN (14,15,16)
            ...
            AND rpg1.CodeID5 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes5,'r_Codes5'))
            AND m.DocDate BETWEEN @ABDate AND @AEDate
          GROUP BY rc4.CodeID4,rpc.CodeID1,m.DocDate           
         ...
         UNION ALL     
          ...
          WHERE m.OurID IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@AOurs,'r_Ours'))
            ...
            AND m.CodeID5 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes5,'r_Codes5'))
            AND m.DocDate BETWEEN @ABDate AND @AEDate
          GROUP BY m.CodeID4,m.CodeID1,DocDate          
    ...
    GROUP BY CodeID4,CodeID1,YearID,MonthID
    ORDER BY CodeID4,CodeID1,YearID,MonthID,SumMC   
      
--Вычисление итоговых сумм 
    SELECT @AYearID = MIN(YearID) 
    FROM @Rep6_6
    
    SET @ATotalText = 'Общий итог'
    
    INSERT INTO @Rep6_6
    SELECT
     CodeID4, CodeID1,(@AYearID + 1) YearID,13 MonthID,SUM(SumMC) SumMC
    FROM @Rep6_6
    GROUP BY CodeID4,CodeID1
 
    SELECT
     rc4.Notes CodeNotes4, rc4.CodeName4,rc1.CodeName1,              
                CASE WHEN MonthID = 13 
						THEN @ATotalText 
						ELSE (dbo.af_GetMonthNameByMonth(MonthID)) END MName,
                SUM(SumMC) SumMC
    FROM @Rep6_6 t6
    JOIN r_Codes4 rc4 WITH(NOLOCK) ON rc4.CodeID4 = t6.CodeID4
    JOIN r_Codes1 rc1 WITH(NOLOCK) ON rc1.CodeID1 = t6.CodeID1
    WHERE SumMC != 0
    GROUP BY rc4.Notes,rc4.CodeName4,rc1.CodeName1,MonthID,YearID
    ORDER BY CodeNotes4,CodeName4,CodeName1,YearID,MonthID
/*
SELECT * FROM r_ProdG1 WHERE StorageAreas = 'Комплекс-Бар'
SELECT * FROM r_Codes2
WHERE CodeName2 LIKE '%24 %  с 01.07.2016  - годовых по платежам  АТБ  (27 % с 01.11.2015) %'
WHERE CodeID4 IN (SELECT AValue FROM dbo.af_FilterToTableByTable(@ACodes4,'r_Codes4'))
...
JOIN r_Deps r_Deps_224 WITH(NOLOCK) ON (r_Deps_224.DepID=r_Stocks_199.DepID)
  WHERE  ((t_Rec_1.CodeID1 BETWEEN 2000 AND 2005) OR (t_Rec_1.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Rec_1.CodeID4 BETWEEN 2000 AND 2029) OR (t_Rec_1.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Rec_1.CodeID5 = 2006) OR (t_Rec_1.CodeID5 = 2007) OR (t_Rec_1.CodeID5 = 2008) OR (t_Rec_1.CodeID5 = 2010) OR (t_Rec_1.CodeID5 = 2018) OR (t_Rec_1.CodeID5 = 2022)) AND ((t_Rec_1.OurID BETWEEN 1 AND 6) OR (t_Rec_1.OurID = 11)) AND (t_Rec_1.DocDate BETWEEN '20180401' AND '20180731') AND (t_Rec_1.OurID IN (14,15,16)) GROUP BY t_Rec_1.DocDate, t_Rec_1.OurID, r_Ours_22.OurName, t_Rec_1.CodeID1, r_Codes1_42.CodeName1, t_Rec_1.CodeID2, r_Codes1_42.Notes, r_Codes2_52.CodeName2, r_Codes2_52.Notes, t_Rec_1.CodeID3, r_Codes3_62.CodeName3, r_Codes3_62.Notes, t_Rec_1.CodeID4, r_Codes4_72.CodeName4, r_Codes4_72.Notes, t_Rec_1.CodeID5, r_Codes5_82.CodeName5, r_Codes5_82.Notes, t_Rec_1.DepID, r_Deps_264.DepName
...
JOIN r_Deps r_Deps_225 WITH(NOLOCK) ON (r_Deps_225.DepID=r_Stocks_195.DepID)
  WHERE  ((t_Ret_2.CodeID1 BETWEEN 2000 AND 2005) OR (t_Ret_2.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Ret_2.CodeID4 BETWEEN 2000 AND 2029) OR (t_Ret_2.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Ret_2.CodeID5 = 2006) OR (t_Ret_2.CodeID5 = 2007) OR (t_Ret_2.CodeID5 = 2008) OR (t_Ret_2.CodeID5 = 2010) OR (t_Ret_2.CodeID5 = 2018) OR (t_Ret_2.CodeID5 = 2022)) AND ((t_Ret_2.OurID BETWEEN 1 AND 6) OR (t_Ret_2.OurID = 11)) AND (t_Ret_2.DocDate BETWEEN '20180401' AND '20180731') AND (t_Ret_2.OurID IN (14,15,16)) GROUP BY t_Ret_2.DocDate, t_Ret_2.OurID, r_Ours_23.OurName, t_Ret_2.CodeID1, r_Codes1_43.CodeName1, t_Ret_2.CodeID2, r_Codes1_43.Notes, r_Codes2_53.CodeName2, r_Codes2_53.Notes, t_Ret_2.CodeID3, r_Codes3_63.CodeName3, r_Codes3_63.Notes, t_Ret_2.CodeID4, r_Codes4_73.CodeName4, r_Codes4_73.Notes, t_Ret_2.CodeID5, r_Codes5_83.CodeName5, r_Codes5_83.Notes, t_Ret_2.DepID, r_Deps_267.DepName
...
JOIN r_Deps r_Deps_228 WITH(NOLOCK) ON (r_Deps_228.DepID=r_Stocks_202.DepID)
  WHERE  ((t_Exp_5.CodeID1 BETWEEN 2000 AND 2005) OR (t_Exp_5.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Exp_5.CodeID4 BETWEEN 2000 AND 2029) OR (t_Exp_5.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Exp_5.CodeID5 = 2006) OR (t_Exp_5.CodeID5 = 2007) OR (t_Exp_5.CodeID5 = 2008) OR (t_Exp_5.CodeID5 = 2010) OR (t_Exp_5.CodeID5 = 2018) OR (t_Exp_5.CodeID5 = 2022)) AND ((t_Exp_5.OurID BETWEEN 1 AND 6) OR (t_Exp_5.OurID = 11)) AND (t_Exp_5.DocDate BETWEEN '20180401' AND '20180731') AND (t_Exp_5.OurID IN (14,15,16)) GROUP BY t_Exp_5.DocDate, t_Exp_5.OurID, r_Ours_26.OurName, t_Exp_5.CodeID1, r_Codes1_46.CodeName1, t_Exp_5.CodeID2, r_Codes1_46.Notes, r_Codes2_56.CodeName2, r_Codes2_56.Notes, t_Exp_5.CodeID3, r_Codes3_66.CodeName3, r_Codes3_66.Notes, t_Exp_5.CodeID4, r_Codes4_76.CodeName4, r_Codes4_76.Notes, t_Exp_5.CodeID5, r_Codes5_86.CodeName5, r_Codes5_86.Notes, t_Exp_5.DepID, r_Deps_320.DepName
...
JOIN r_Codes4 r_Codes4_193 WITH(NOLOCK) ON (r_Codes4_193.CodeID4=r_StockGs_190.StockGID)
  WHERE  ((r_Codes1_183.CodeID1 BETWEEN 2000 AND 2005) OR (r_Codes1_183.CodeID1 BETWEEN 2007 AND 3001)) 
     AND ((r_Codes4_193.CodeID4 BETWEEN 2000 AND 2029) OR (r_Codes4_193.CodeID4 BETWEEN 2100 AND 5000)) 
     AND ((r_Codes5_185.CodeID5 = 2006) OR (r_Codes5_185.CodeID5 = 2007) OR (r_Codes5_185.CodeID5 = 2008) OR (r_Codes5_185.CodeID5 = 2010) OR (r_Codes5_185.CodeID5 = 2018) OR (r_Codes5_185.CodeID5 = 2022)) AND ((t_Est_7.OurID BETWEEN 1 AND 6) OR (t_Est_7.OurID = 11)) AND (t_Est_7.DocDate BETWEEN '20180401' AND '20180731') AND ((t_Est_7.OurID IN (14,15,16) AND (r_Prods_168.PCatID BETWEEN 600 AND 699) AND ((r_Prods_168.PGrID BETWEEN 9100 AND 9999) OR (r_Prods_168.PGrID BETWEEN 16000 AND 17000)))) GROUP BY t_Est_7.DocDate, t_Est_7.OurID, r_Ours_29.OurName, r_Codes1_183.CodeID1, r_Codes1_183.CodeName1, r_Codes2_184.CodeID2, r_Codes1_183.Notes, r_Codes2_184.CodeName2, r_Codes2_184.Notes, t_Est_7.CodeID3, r_Codes3_69.CodeName3, r_Codes3_69.Notes, r_Codes4_193.CodeID4, r_Codes4_193.CodeName4, r_Codes4_193.Notes, r_Codes5_185.CodeID5, r_Codes5_185.CodeName5, r_Codes5_185.Notes, r_Deps_230.DepID, r_Deps_230.DepName
...
JOIN r_Deps r_Deps_231 WITH(NOLOCK) ON (r_Deps_231.DepID=r_Stocks_198.DepID)
  WHERE  ((c_CompRec_9.CodeID1 BETWEEN 2000 AND 2005) OR (c_CompRec_9.CodeID1 BETWEEN 2007 AND 3001)) AND ((c_CompRec_9.CodeID4 BETWEEN 2000 AND 2029) OR (c_CompRec_9.CodeID4 BETWEEN 2100 AND 5000)) AND ((c_CompRec_9.CodeID5 = 2006) OR (c_CompRec_9.CodeID5 = 2007) OR (c_CompRec_9.CodeID5 = 2008) OR (c_CompRec_9.CodeID5 = 2010) OR (c_CompRec_9.CodeID5 = 2018) OR (c_CompRec_9.CodeID5 = 2022)) AND ((c_CompRec_9.OurID BETWEEN 1 AND 6) OR (c_CompRec_9.OurID = 11)) AND (c_CompRec_9.DocDate BETWEEN '20180401' AND '20180731') AND (c_CompRec_9.OurID IN  (14,15,16)) GROUP BY c_CompRec_9.DocDate, c_CompRec_9.OurID, r_Ours_30.OurName, c_CompRec_9.CodeID1, r_Codes1_50.CodeName1, c_CompRec_9.CodeID2, r_Codes1_50.Notes, r_Codes2_60.CodeName2, r_Codes2_60.Notes, c_CompRec_9.CodeID3, r_Codes3_70.CodeName3, r_Codes3_70.Notes, c_CompRec_9.CodeID4, r_Codes4_80.CodeName4, r_Codes4_80.Notes, c_CompRec_9.CodeID5, r_Codes5_90.CodeName5, r_Codes5_90.Notes, c_CompRec_9.DepID, r_Deps_344.DepName
...
JOIN r_Deps r_Deps_232 WITH(NOLOCK) ON (r_Deps_232.DepID=r_Stocks_200.DepID)
  WHERE  ((c_CompExp_10.CodeID1 BETWEEN 2000 AND 2005) OR (c_CompExp_10.CodeID1 BETWEEN 2007 AND 3001)) AND ((c_CompExp_10.CodeID4 BETWEEN 2000 AND 2029) OR (c_CompExp_10.CodeID4 BETWEEN 2100 AND 5000)) AND ((c_CompExp_10.CodeID5 = 2006) OR (c_CompExp_10.CodeID5 = 2007) OR (c_CompExp_10.CodeID5 = 2008) OR (c_CompExp_10.CodeID5 = 2010) OR (c_CompExp_10.CodeID5 = 2018) OR (c_CompExp_10.CodeID5 = 2022)) AND ((c_CompExp_10.OurID BETWEEN 1 AND 6) OR (c_CompExp_10.OurID = 11)) AND (c_CompExp_10.DocDate BETWEEN '20180401' AND '20180731') AND (c_CompExp_10.OurID IN (14,15,16)) GROUP BY c_CompExp_10.DocDate, c_CompExp_10.OurID, r_Ours_31.OurName, c_CompExp_10.CodeID1, r_Codes1_51.CodeName1, c_CompExp_10.CodeID2, r_Codes1_51.Notes, r_Codes2_61.CodeName2, r_Codes2_61.Notes, c_CompExp_10.CodeID3, r_Codes3_71.CodeName3, r_Codes3_71.Notes, c_CompExp_10.CodeID4, r_Codes4_81.CodeName4, r_Codes4_81.Notes, c_CompExp_10.CodeID5, r_Codes5_91.CodeName5, r_Codes5_91.Notes, c_CompExp_10.DepID, r_Deps_347.DepName
...
JOIN r_Deps r_Deps_233 WITH(NOLOCK) ON (r_Deps_233.DepID=r_Stocks_197.DepID)
  WHERE  ((t_MonRec_11.CodeID1 BETWEEN 2000 AND 2005) OR (t_MonRec_11.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_MonRec_11.CodeID4 BETWEEN 2000 AND 2029) OR (t_MonRec_11.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_MonRec_11.CodeID5 = 2006) OR (t_MonRec_11.CodeID5 = 2007) OR (t_MonRec_11.CodeID5 = 2008) OR (t_MonRec_11.CodeID5 = 2010) OR (t_MonRec_11.CodeID5 = 2018) OR (t_MonRec_11.CodeID5 = 2022)) AND ((t_MonRec_11.OurID BETWEEN 1 AND 6) OR (t_MonRec_11.OurID = 11)) AND (t_MonRec_11.DocDate BETWEEN '20180401' AND '20180731') AND (t_MonRec_11.OurID IN (14,15,16)) GROUP BY t_MonRec_11.DocDate, t_MonRec_11.OurID, r_Ours_28.OurName, t_MonRec_11.CodeID1, r_Codes1_48.CodeName1, t_MonRec_11.CodeID2, r_Codes1_48.Notes, r_Codes2_58.CodeName2, r_Codes2_58.Notes, t_MonRec_11.CodeID3, r_Codes3_68.CodeName3, r_Codes3_68.Notes, t_MonRec_11.CodeID4, r_Codes4_78.CodeName4, r_Codes4_78.Notes, t_MonRec_11.CodeID5, r_Codes5_88.CodeName5, r_Codes5_88.Notes
...
JOIN r_Codes4 r_Codes4_194 WITH(NOLOCK) ON (r_Codes4_194.CodeID4=r_StockGs_192.StockGID)
  WHERE  ((r_Codes1_186.CodeID1 BETWEEN 2000 AND 2005) OR (r_Codes1_186.CodeID1 BETWEEN 2007 AND 3001)) AND ((r_Codes4_194.CodeID4 BETWEEN 2000 AND 2029) OR (r_Codes4_194.CodeID4 BETWEEN 2100 AND 5000)) AND ((r_Codes5_188.CodeID5 = 2006) OR (r_Codes5_188.CodeID5 = 2007) OR (r_Codes5_188.CodeID5 = 2008) OR (r_Codes5_188.CodeID5 = 2010) OR (r_Codes5_188.CodeID5 = 2018) OR (r_Codes5_188.CodeID5 = 2022)) AND ((t_Est_156.OurID BETWEEN 1 AND 6) OR (t_Est_156.OurID = 11)) AND (t_Est_156.DocDate BETWEEN '20180401' AND '20180731') AND ((t_Est_156.OurID IN (14,15,16) AND (r_Prods_172.PCatID BETWEEN 600 AND 699) AND ((r_Prods_172.PGrID BETWEEN 9100 AND 9999) OR (r_Prods_172.PGrID BETWEEN 16000 AND 17000)))) GROUP BY t_Est_156.DocDate, t_Est_156.OurID, r_Ours_159.OurName, r_Codes1_186.CodeID1, r_Codes1_186.CodeName1, r_Codes2_187.CodeID2, r_Codes1_186.Notes, r_Codes2_187.CodeName2, r_Codes2_187.Notes, t_Est_156.CodeID3, r_Codes3_162.CodeName3, r_Codes3_162.Notes, r_Codes4_194.CodeID4, r_Codes4_194.CodeName4, r_Codes4_194.Notes, r_Codes5_188.CodeID5, r_Codes5_188.CodeName5, r_Codes5_188.Notes, r_Deps_234.DepID, r_Deps_234.DepName
...
JOIN r_Deps r_Deps_235 WITH(NOLOCK) ON (r_Deps_235.DepID=r_Stocks_214.DepID)
  WHERE  ((t_CRRet_204.CodeID1 BETWEEN 2000 AND 2005) OR (t_CRRet_204.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_CRRet_204.CodeID4 BETWEEN 2000 AND 2029) OR (t_CRRet_204.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_CRRet_204.CodeID5 = 2006) OR (t_CRRet_204.CodeID5 = 2007) OR (t_CRRet_204.CodeID5 = 2008) OR (t_CRRet_204.CodeID5 = 2010) OR (t_CRRet_204.CodeID5 = 2018) OR (t_CRRet_204.CodeID5 = 2022)) AND ((t_CRRet_204.OurID BETWEEN 1 AND 6) OR (t_CRRet_204.OurID = 11)) AND (t_CRRet_204.DocDate BETWEEN '20180401' AND '20180731') AND (t_CRRet_204.OurID IN (14,15,16)) GROUP BY t_CRRet_204.DocDate, t_CRRet_204.OurID, r_Ours_208.OurName, t_CRRet_204.CodeID1, r_Codes1_209.CodeName1, t_CRRet_204.CodeID2, r_Codes1_209.Notes, r_Codes2_210.CodeName2, r_Codes2_210.Notes, t_CRRet_204.CodeID3, r_Codes3_211.CodeName3, r_Codes3_211.Notes, t_CRRet_204.CodeID4, r_Codes4_212.CodeName4, r_Codes4_212.Notes, t_CRRet_204.CodeID5, r_Codes5_213.CodeName5, r_Codes5_213.Notes
...
JOIN r_Deps r_Deps_236 WITH(NOLOCK) ON (r_Deps_236.DepID=r_Stocks_221.DepID)
  WHERE  ((t_Sale_206.CodeID1 BETWEEN 2000 AND 2005) OR (t_Sale_206.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Sale_206.CodeID4 BETWEEN 2000 AND 2029) OR (t_Sale_206.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Sale_206.CodeID5 = 2006) OR (t_Sale_206.CodeID5 = 2007) OR (t_Sale_206.CodeID5 = 2008) OR (t_Sale_206.CodeID5 = 2010) OR (t_Sale_206.CodeID5 = 2018) OR (t_Sale_206.CodeID5 = 2022)) AND ((t_Sale_206.OurID BETWEEN 1 AND 6) OR (t_Sale_206.OurID = 11)) AND (t_Sale_206.DocDate BETWEEN '20180401' AND '20180731') AND (t_Sale_206.OurID IN (14,15,16)) GROUP BY t_Sale_206.DocDate, t_Sale_206.OurID, r_Ours_215.OurName, t_Sale_206.CodeID1, r_Codes1_216.CodeName1, t_Sale_206.CodeID2, r_Codes1_216.Notes, r_Codes2_217.CodeName2, r_Codes2_217.Notes, t_Sale_206.CodeID3, r_Codes3_218.CodeName3, r_Codes3_218.Notes, t_Sale_206.CodeID4, r_Codes4_219.CodeName4, r_Codes4_219.Notes, t_Sale_206.CodeID5, r_Codes5_220.CodeName5, r_Codes5_220.Notes
...
JOIN t_PInP t_PInP_146 WITH(NOLOCK) ON (t_PInP_146.PPID=t_RecD_145.PPID AND t_PInP_146.ProdID=t_RecD_145.ProdID)
JOIN r_Deps r_Deps_224 WITH(NOLOCK) ON (r_Deps_224.DepID=r_Stocks_199.DepID)
  WHERE  ((t_Rec_1.CodeID1 BETWEEN 2000 AND 2005) OR (t_Rec_1.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Rec_1.CodeID4 BETWEEN 2000 AND 2029) OR (t_Rec_1.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Rec_1.CodeID5 = 2006) OR (t_Rec_1.CodeID5 = 2007) OR (t_Rec_1.CodeID5 = 2008) OR (t_Rec_1.CodeID5 = 2010) OR (t_Rec_1.CodeID5 = 2018) OR (t_Rec_1.CodeID5 = 2022)) AND ((t_Rec_1.OurID BETWEEN 1 AND 6) OR (t_Rec_1.OurID = 11)) AND (t_Rec_1.DocDate BETWEEN '20180201' AND '20180731') AND (t_Rec_1.OurID IN (1,11,2,3,5,6,4)) GROUP BY t_Rec_1.DocDate, t_Rec_1.OurID, r_Ours_22.OurName, t_Rec_1.CodeID1, r_Codes1_42.CodeName1, t_Rec_1.CodeID2, r_Codes1_42.Notes, r_Codes2_52.CodeName2, r_Codes2_52.Notes, t_Rec_1.CodeID3, r_Codes3_62.CodeName3, r_Codes3_62.Notes, t_Rec_1.CodeID4, r_Codes4_72.CodeName4, r_Codes4_72.Notes, t_Rec_1.CodeID5, r_Codes5_82.CodeName5, r_Codes5_82.Notes, t_Rec_1.DepID, r_Deps_264.DepName
>>> Расход (Факт) - Возврат товара от получателя: -- doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
...
JOIN t_PInP t_PInP_142 WITH(NOLOCK) ON (t_PInP_142.PPID=t_RetD_141.PPID AND t_PInP_142.ProdID=t_RetD_141.ProdID)
JOIN r_Deps r_Deps_225 WITH(NOLOCK) ON (r_Deps_225.DepID=r_Stocks_195.DepID)
  WHERE  ((t_Ret_2.CodeID1 BETWEEN 2000 AND 2005) OR (t_Ret_2.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Ret_2.CodeID4 BETWEEN 2000 AND 2029) OR (t_Ret_2.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Ret_2.CodeID5 = 2006) OR (t_Ret_2.CodeID5 = 2007) OR (t_Ret_2.CodeID5 = 2008) OR (t_Ret_2.CodeID5 = 2010) OR (t_Ret_2.CodeID5 = 2018) OR (t_Ret_2.CodeID5 = 2022)) AND ((t_Ret_2.OurID BETWEEN 1 AND 6) OR (t_Ret_2.OurID = 11)) AND (t_Ret_2.DocDate BETWEEN '20180201' AND '20180731') AND (t_Ret_2.OurID IN (1,11,2,3,5,6,4))
  GROUP BY t_Ret_2.DocDate, t_Ret_2.OurID, r_Ours_23.OurName, t_Ret_2.CodeID1, r_Codes1_43.CodeName1, t_Ret_2.CodeID2, r_Codes1_43.Notes, r_Codes2_53.CodeName2, r_Codes2_53.Notes, t_Ret_2.CodeID3, r_Codes3_63.CodeName3, r_Codes3_63.Notes, t_Ret_2.CodeID4, r_Codes4_73.CodeName4, r_Codes4_73.Notes, t_Ret_2.CodeID5, r_Codes5_83.CodeName5, r_Codes5_83.Notes, t_Ret_2.DepID, r_Deps_267.DepName
>>> Расход (Факт) - Возврат товара поставщику:--emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
...
>>> Расход (Факт) - Расходная накладная: --emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
...
JOIN t_PInP t_PInP_148 WITH(NOLOCK) ON (t_PInP_148.PPID=t_InvD_147.PPID AND t_PInP_148.ProdID=t_InvD_147.ProdID)
JOIN r_Deps r_Deps_227 WITH(NOLOCK) ON (r_Deps_227.DepID=r_Stocks_201.DepID)
  WHERE  ((t_Inv_4.CodeID1 BETWEEN 2000 AND 2005) OR (t_Inv_4.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Inv_4.CodeID4 BETWEEN 2000 AND 2029) OR (t_Inv_4.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Inv_4.CodeID5 = 2006) OR (t_Inv_4.CodeID5 = 2007) OR (t_Inv_4.CodeID5 = 2008) OR (t_Inv_4.CodeID5 = 2010) OR (t_Inv_4.CodeID5 = 2018) OR (t_Inv_4.CodeID5 = 2022)) AND ((t_Inv_4.OurID BETWEEN 1 AND 6) OR (t_Inv_4.OurID = 11)) AND (t_Inv_4.DocDate BETWEEN '20180201' AND '20180731') AND (t_Inv_4.OurID IN (1,11,2,3,5,6,4)) GROUP BY t_Inv_4.DocDate, t_Inv_4.OurID, r_Ours_25.OurName, t_Inv_4.CodeID1, r_Codes1_45.CodeName1, t_Inv_4.CodeID2, r_Codes1_45.Notes, r_Codes2_55.CodeName2, r_Codes2_55.Notes, t_Inv_4.CodeID3, r_Codes3_65.CodeName3, r_Codes3_65.Notes, t_Inv_4.CodeID4, r_Codes4_75.CodeName4, r_Codes4_75.Notes, t_Inv_4.CodeID5, r_Codes5_85.CodeName5, r_Codes5_85.Notes, t_Inv_4.DepID, r_Deps_297.DepName
>>> Расход (Факт) - Расходный документ: -- doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif) 
SELECT r_Codes4_76.Notes Notes4,r_Codes4_76.CodeName4,r_Codes1_46.CodeName1, t_Exp_5.DocDate, SUM(t_ExpD_149.Qty * t_PInP_150.CostMC) SumMC, SUM((t_ExpD_149.Qty * t_PInP_150.CostCC) / 9) SumMC_K, SUM(t_ExpD_149.Qty * ((t_PInP_150.CostCC / 9) - t_PInP_150.CostMC)) SumCurrDif 
FROM av_t_Exp t_Exp_5 WITH(NOLOCK)
JOIN r_Codes1 r_Codes1_46 WITH(NOLOCK) ON (r_Codes1_46.CodeID1=t_Exp_5.CodeID1)
JOIN r_Codes2 r_Codes2_56 WITH(NOLOCK) ON (r_Codes2_56.CodeID2=t_Exp_5.CodeID2)
JOIN r_Codes3 r_Codes3_66 WITH(NOLOCK) ON (r_Codes3_66.CodeID3=t_Exp_5.CodeID3)
JOIN r_Codes4 r_Codes4_76 WITH(NOLOCK) ON (r_Codes4_76.CodeID4=t_Exp_5.CodeID4)
...
JOIN t_PInP t_PInP_150 WITH(NOLOCK) ON (t_PInP_150.PPID=t_ExpD_149.PPID AND t_PInP_150.ProdID=t_ExpD_149.ProdID)
JOIN r_Deps r_Deps_228 WITH(NOLOCK) ON (r_Deps_228.DepID=r_Stocks_202.DepID)
  WHERE  ((t_Exp_5.CodeID1 BETWEEN 2000 AND 2005) OR (t_Exp_5.CodeID1 BETWEEN 2007 AND 3001))
     AND ((t_Exp_5.CodeID4 BETWEEN 2000 AND 2029) OR (t_Exp_5.CodeID4 BETWEEN 2100 AND 5000))
     AND ((t_Exp_5.CodeID5 = 2006) OR (t_Exp_5.CodeID5 = 2007) OR (t_Exp_5.CodeID5 = 2008) OR (t_Exp_5.CodeID5 = 2010) OR (t_Exp_5.CodeID5 = 2018) OR (t_Exp_5.CodeID5 = 2022)) AND ((t_Exp_5.OurID BETWEEN 1 AND 6) OR (t_Exp_5.OurID = 11)) AND (t_Exp_5.DocDate BETWEEN '20180201' AND '20180731') AND (t_Exp_5.OurID IN (1,11,2,3,5,6,4)) 
     GROUP BY r_Codes4_76.Notes,r_Codes4_76.CodeName4,r_Codes1_46.CodeName1, t_Exp_5.DocDate
>>> Расход (Факт) - Расходный документ в ценах прихода:--doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
SELECT r_Codes4_77.Notes Notes4, r_Codes4_77.CodeName4, r_Codes1_47.CodeName1, t_Epp_6.DocDate, SUM(t_EppD_151.Qty * t_PInP_152.CostMC) SumMC
FROM av_t_Epp t_Epp_6 WITH(NOLOCK)
JOIN r_Codes1 r_Codes1_47 WITH(NOLOCK) ON (r_Codes1_47.CodeID1=t_Epp_6.CodeID1)
JOIN r_Codes2 r_Codes2_57 WITH(NOLOCK) ON (r_Codes2_57.CodeID2=t_Epp_6.CodeID2)
JOIN r_Codes3 r_Codes3_67 WITH(NOLOCK) ON (r_Codes3_67.CodeID3=t_Epp_6.CodeID3)
JOIN r_Codes4 r_Codes4_77 WITH(NOLOCK) ON (r_Codes4_77.CodeID4=t_Epp_6.CodeID4)
...
JOIN t_PInP t_PInP_152 WITH(NOLOCK) ON (t_PInP_152.PPID=t_EppD_151.PPID AND t_PInP_152.ProdID=t_EppD_151.ProdID)
JOIN r_Deps r_Deps_229 WITH(NOLOCK) ON (r_Deps_229.DepID=r_Stocks_203.DepID)
  WHERE  ((t_Epp_6.CodeID1 BETWEEN 2000 AND 2005) OR (t_Epp_6.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Epp_6.CodeID4 BETWEEN 2000 AND 2029) OR (t_Epp_6.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Epp_6.CodeID5 = 2006) OR (t_Epp_6.CodeID5 = 2007) OR (t_Epp_6.CodeID5 = 2008) OR (t_Epp_6.CodeID5 = 2010) OR (t_Epp_6.CodeID5 = 2018) OR (t_Epp_6.CodeID5 = 2022)) AND ((t_Epp_6.OurID BETWEEN 1 AND 6) OR (t_Epp_6.OurID = 11)) AND (t_Epp_6.DocDate BETWEEN '20180201' AND '20180731') AND (t_Epp_6.OurID IN (1,11,2,3,5,6,4))
  GROUP BY r_Codes4_77.Notes, r_Codes4_77.CodeName4, r_Codes1_47.CodeName1, t_Epp_6.DocDate
>>> Расход (Факт) - Переоценка цен прихода (Приход): -- doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif) 
SELECT r_Codes4_193.Notes Notes4, r_Codes4_193.CodeName4, r_Codes1_183.CodeName1, t_Est_7.DocDate, SUM(0-(t_EstD_153.Qty * t_PInP_154.CostMC)) SumMC FROM av_t_Est t_Est_7 WITH(NOLOCK)
JOIN r_Codes3 r_Codes3_69 WITH(NOLOCK) ON (r_Codes3_69.CodeID3=t_Est_7.CodeID3)
JOIN r_Ours r_Ours_29 WITH(NOLOCK) ON (r_Ours_29.OurID=t_Est_7.OurID)
JOIN r_Stocks r_Stocks_189 WITH(NOLOCK) ON (r_Stocks_189.StockID=t_Est_7.StockID)
JOIN av_t_EstD t_EstD_153 WITH(NOLOCK) ON (t_EstD_153.ChID=t_Est_7.ChID)
...
JOIN r_Codes4 r_Codes4_193 WITH(NOLOCK) ON (r_Codes4_193.CodeID4=r_StockGs_190.StockGID)
  WHERE  ((r_Codes1_183.CodeID1 BETWEEN 2000 AND 2005) OR (r_Codes1_183.CodeID1 BETWEEN 2007 AND 3001))
     AND ((r_Codes4_193.CodeID4 BETWEEN 2000 AND 2029) OR (r_Codes4_193.CodeID4 BETWEEN 2100 AND 5000))
     AND ((r_Codes5_185.CodeID5 = 2006) OR (r_Codes5_185.CodeID5 = 2007) OR (r_Codes5_185.CodeID5 = 2008) OR (r_Codes5_185.CodeID5 = 2010) OR (r_Codes5_185.CodeID5 = 2018) OR (r_Codes5_185.CodeID5 = 2022)) AND ((t_Est_7.OurID BETWEEN 1 AND 6) OR (t_Est_7.OurID = 11)) AND (t_Est_7.DocDate BETWEEN '20180201' AND '20180731') AND ((t_Est_7.OurID IN (1,11,2,3,5,6,4) AND (r_Prods_168.PCatID BETWEEN 600 AND 699) AND ((r_Prods_168.PGrID BETWEEN 9100 AND 9999) OR (r_Prods_168.PGrID BETWEEN 16000 AND 17000))))
     GROUP BY r_Codes4_193.Notes, r_Codes4_193.CodeName4, r_Codes1_183.CodeName1, t_Est_7.DocDate
>>> Расход (Факт) - Приход денег по предприятиям: --emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif) 
...
JOIN r_Stocks r_Stocks_198 WITH(NOLOCK) ON (r_Stocks_198.StockID=c_CompRec_9.StockID)
JOIN r_Deps r_Deps_231 WITH(NOLOCK) ON (r_Deps_231.DepID=r_Stocks_198.DepID)
  WHERE  ((c_CompRec_9.CodeID1 BETWEEN 2000 AND 2005) OR (c_CompRec_9.CodeID1 BETWEEN 2007 AND 3001)) 
     AND ((c_CompRec_9.CodeID4 BETWEEN 2000 AND 2029) OR (c_CompRec_9.CodeID4 BETWEEN 2100 AND 5000)) 
     AND ((c_CompRec_9.CodeID5 = 2006) OR (c_CompRec_9.CodeID5 = 2007) OR (c_CompRec_9.CodeID5 = 2008) OR (c_CompRec_9.CodeID5 = 2010) OR (c_CompRec_9.CodeID5 = 2018) OR (c_CompRec_9.CodeID5 = 2022)) AND ((c_CompRec_9.OurID BETWEEN 1 AND 6) OR (c_CompRec_9.OurID = 11)) AND (c_CompRec_9.DocDate BETWEEN '20180201' AND '20180731') AND (c_CompRec_9.OurID IN (1,11,2,3,5,6,4)) 
     GROUP BY c_CompRec_9.DocDate, c_CompRec_9.OurID, r_Ours_30.OurName, c_CompRec_9.CodeID1, r_Codes1_50.CodeName1, c_CompRec_9.CodeID2, r_Codes1_50.Notes, r_Codes2_60.CodeName2, r_Codes2_60.Notes, c_CompRec_9.CodeID3, r_Codes3_70.CodeName3, r_Codes3_70.Notes, c_CompRec_9.CodeID4, r_Codes4_80.CodeName4, r_Codes4_80.Notes, c_CompRec_9.CodeID5, r_Codes5_90.CodeName5, r_Codes5_90.Notes, c_CompRec_9.DepID, r_Deps_344.DepName
>>> Расход (Факт) - Расход денег по предприятиям: --doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
SELECT r_Codes4_81.Notes Notes4, r_Codes4_81.CodeName4, r_Codes1_51.CodeName1, DATEPART(MONTH,c_CompExp_10.DocDate) MonthID, SUM(c_CompExp_10.SumAC / c_CompExp_10.KursMC) SumMC FROM av_c_CompExp c_CompExp_10 WITH(NOLOCK)
JOIN r_Codes1 r_Codes1_51 WITH(NOLOCK) ON (r_Codes1_51.CodeID1=c_CompExp_10.CodeID1)
JOIN r_Codes2 r_Codes2_61 WITH(NOLOCK) ON (r_Codes2_61.CodeID2=c_CompExp_10.CodeID2)
JOIN r_Codes3 r_Codes3_71 WITH(NOLOCK) ON (r_Codes3_71.CodeID3=c_CompExp_10.CodeID3)
JOIN r_Codes4 r_Codes4_81 WITH(NOLOCK) ON (r_Codes4_81.CodeID4=c_CompExp_10.CodeID4)
...
JOIN r_Stocks r_Stocks_200 WITH(NOLOCK) ON (r_Stocks_200.StockID=c_CompExp_10.StockID)
JOIN r_Deps r_Deps_232 WITH(NOLOCK) ON (r_Deps_232.DepID=r_Stocks_200.DepID)
  WHERE  ((c_CompExp_10.CodeID1 BETWEEN 2000 AND 2005) OR (c_CompExp_10.CodeID1 BETWEEN 2007 AND 3001)) AND ((c_CompExp_10.CodeID4 BETWEEN 2000 AND 2029) OR (c_CompExp_10.CodeID4 BETWEEN 2100 AND 5000)) AND ((c_CompExp_10.CodeID5 = 2006) OR (c_CompExp_10.CodeID5 = 2007) OR (c_CompExp_10.CodeID5 = 2008) OR (c_CompExp_10.CodeID5 = 2010) OR (c_CompExp_10.CodeID5 = 2018) OR (c_CompExp_10.CodeID5 = 2022)) AND ((c_CompExp_10.OurID BETWEEN 1 AND 6) OR (c_CompExp_10.OurID = 11)) AND (c_CompExp_10.DocDate BETWEEN '20180201' AND '20180731') AND (c_CompExp_10.OurID IN (1,11,2,3,5,6,4))
  GROUP BY r_Codes4_81.Notes, r_Codes4_81.CodeName4, r_Codes1_51.CodeName1, DATEPART(MONTH,c_CompExp_10.DocDate)
>>> Расход (Факт) - Прием наличных денег на склад: --emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
...
JOIN r_Stocks r_Stocks_197 WITH(NOLOCK) ON (r_Stocks_197.StockID=t_MonRec_11.StockID)
JOIN r_Deps r_Deps_233 WITH(NOLOCK) ON (r_Deps_233.DepID=r_Stocks_197.DepID)
  WHERE  ((t_MonRec_11.CodeID1 BETWEEN 2000 AND 2005) OR (t_MonRec_11.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_MonRec_11.CodeID4 BETWEEN 2000 AND 2029) OR (t_MonRec_11.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_MonRec_11.CodeID5 = 2006) OR (t_MonRec_11.CodeID5 = 2007) OR (t_MonRec_11.CodeID5 = 2008) OR (t_MonRec_11.CodeID5 = 2010) OR (t_MonRec_11.CodeID5 = 2018) OR (t_MonRec_11.CodeID5 = 2022)) AND ((t_MonRec_11.OurID BETWEEN 1 AND 6) OR (t_MonRec_11.OurID = 11)) AND (t_MonRec_11.DocDate BETWEEN '20180201' AND '20180731') AND (t_MonRec_11.OurID IN (1,11,2,3,5,6,4)) GROUP BY t_MonRec_11.DocDate, t_MonRec_11.OurID, r_Ours_28.OurName, t_MonRec_11.CodeID1, r_Codes1_48.CodeName1, t_MonRec_11.CodeID2, r_Codes1_48.Notes, r_Codes2_58.CodeName2, r_Codes2_58.Notes, t_MonRec_11.CodeID3, r_Codes3_68.CodeName3, r_Codes3_68.Notes, t_MonRec_11.CodeID4, r_Codes4_78.CodeName4, r_Codes4_78.Notes, t_MonRec_11.CodeID5, r_Codes5_88.CodeName5, r_Codes5_88.Notes
>>> Расход (Факт) - Переоценка цен прихода (Расход): -- doneINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif)
SELECT r_Codes4_194.Notes Notes4, r_Codes4_194.CodeName4, r_Codes1_186.CodeName1, t_Est_156.DocDate, SUM(t_EstD_157.Qty * t_PInP_167.CostMC) SumMC FROM av_t_Est t_Est_156 WITH(NOLOCK)
JOIN r_Codes3 r_Codes3_162 WITH(NOLOCK) ON (r_Codes3_162.CodeID3=t_Est_156.CodeID3)
JOIN r_Ours r_Ours_159 WITH(NOLOCK) ON (r_Ours_159.OurID=t_Est_156.OurID)
JOIN r_Stocks r_Stocks_191 WITH(NOLOCK) ON (r_Stocks_191.StockID=t_Est_156.StockID)
JOIN av_t_EstD t_EstD_157 WITH(NOLOCK) ON (t_EstD_157.ChID=t_Est_156.ChID)
...
JOIN r_StockGs r_StockGs_192 WITH(NOLOCK) ON (r_StockGs_192.StockGID=r_Stocks_191.StockGID)
JOIN r_Codes4 r_Codes4_194 WITH(NOLOCK) ON (r_Codes4_194.CodeID4=r_StockGs_192.StockGID)
  WHERE  ((r_Codes1_186.CodeID1 BETWEEN 2000 AND 2005) OR (r_Codes1_186.CodeID1 BETWEEN 2007 AND 3001)) 
	 AND ((r_Codes4_194.CodeID4 BETWEEN 2000 AND 2029) OR (r_Codes4_194.CodeID4 BETWEEN 2100 AND 5000)) 
	 AND ((r_Codes5_188.CodeID5 = 2006) OR (r_Codes5_188.CodeID5 = 2007) OR (r_Codes5_188.CodeID5 = 2008) OR (r_Codes5_188.CodeID5 = 2010) OR (r_Codes5_188.CodeID5 = 2018) OR (r_Codes5_188.CodeID5 = 2022)) 
	 AND ((t_Est_156.OurID BETWEEN 1 AND 6) OR (t_Est_156.OurID = 11)) AND (t_Est_156.DocDate BETWEEN '20180201' AND '20180731') AND ((t_Est_156.OurID IN (1,11,2,3,5,6,4) AND (r_Prods_172.PCatID BETWEEN 600 AND 699) AND ((r_Prods_172.PGrID BETWEEN 9100 AND 9999) OR (r_Prods_172.PGrID BETWEEN 16000 AND 17000)))) 
	 GROUP BY r_Codes4_194.Notes, r_Codes4_194.CodeName4, r_Codes1_186.CodeName1, t_Est_156.DocDate
>>> Расход (Факт) - Возврат товара по чеку: --emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif) 
...
JOIN t_PInP t_PInP_222 WITH(NOLOCK) ON (t_PInP_222.PPID=t_CRRetD_205.PPID AND t_PInP_222.ProdID=t_CRRetD_205.ProdID)
JOIN r_Deps r_Deps_235 WITH(NOLOCK) ON (r_Deps_235.DepID=r_Stocks_214.DepID)
  WHERE  ((t_CRRet_204.CodeID1 BETWEEN 2000 AND 2005) OR (t_CRRet_204.CodeID1 BETWEEN 2007 AND 3001))
     AND ((t_CRRet_204.CodeID4 BETWEEN 2000 AND 2029) OR (t_CRRet_204.CodeID4 BETWEEN 2100 AND 5000))
     AND ((t_CRRet_204.CodeID5 = 2006) OR (t_CRRet_204.CodeID5 = 2007) OR (t_CRRet_204.CodeID5 = 2008) OR (t_CRRet_204.CodeID5 = 2010) OR (t_CRRet_204.CodeID5 = 2018) OR (t_CRRet_204.CodeID5 = 2022)) AND ((t_CRRet_204.OurID BETWEEN 1 AND 6) OR (t_CRRet_204.OurID = 11)) AND (t_CRRet_204.DocDate BETWEEN '20180201' AND '20180731') AND (t_CRRet_204.OurID IN (1,11,2,3,5,6,4)) GROUP BY t_CRRet_204.DocDate, t_CRRet_204.OurID, r_Ours_208.OurName, t_CRRet_204.CodeID1, r_Codes1_209.CodeName1, t_CRRet_204.CodeID2, r_Codes1_209.Notes, r_Codes2_210.CodeName2, r_Codes2_210.Notes, t_CRRet_204.CodeID3, r_Codes3_211.CodeName3, r_Codes3_211.Notes, t_CRRet_204.CodeID4, r_Codes4_212.CodeName4, r_Codes4_212.Notes, t_CRRet_204.CodeID5, r_Codes5_213.CodeName5, r_Codes5_213.Notes
>>> Расход (Факт) - Продажа товара оператором: --emptyINSERT INTO [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] (DocDate, OurID, OurName, CodeID1, CodeName1, CodeID2, Notes1, CodeName2, Notes2, CodeID3, CodeName3, Notes3, CodeID4, CodeName4, Notes4, CodeID5, CodeName5, Notes5, DDepID, DDepName, GMSSourceGroup, SumCC, SumMC, SumMC_K, SumCurrDif) 
...
JOIN t_PInP t_PInP_223 WITH(NOLOCK) ON (t_PInP_223.PPID=t_SaleD_207.PPID AND t_PInP_223.ProdID=t_SaleD_207.ProdID)
JOIN r_Deps r_Deps_236 WITH(NOLOCK) ON (r_Deps_236.DepID=r_Stocks_221.DepID)
  WHERE  ((t_Sale_206.CodeID1 BETWEEN 2000 AND 2005) OR (t_Sale_206.CodeID1 BETWEEN 2007 AND 3001)) AND ((t_Sale_206.CodeID4 BETWEEN 2000 AND 2029) OR (t_Sale_206.CodeID4 BETWEEN 2100 AND 5000)) AND ((t_Sale_206.CodeID5 = 2006) OR (t_Sale_206.CodeID5 = 2007) OR (t_Sale_206.CodeID5 = 2008) OR (t_Sale_206.CodeID5 = 2010) OR (t_Sale_206.CodeID5 = 2018) OR (t_Sale_206.CodeID5 = 2022)) AND ((t_Sale_206.OurID BETWEEN 1 AND 6) OR (t_Sale_206.OurID = 11)) AND (t_Sale_206.DocDate BETWEEN '20180201' AND '20180731') AND (t_Sale_206.OurID IN (1,11,2,3,5,6,4)) GROUP BY t_Sale_206.DocDate, t_Sale_206.OurID, r_Ours_215.OurName, t_Sale_206.CodeID1, r_Codes1_216.CodeName1, t_Sale_206.CodeID2, r_Codes1_216.Notes, r_Codes2_217.CodeName2, r_Codes2_217.Notes, t_Sale_206.CodeID3, r_Codes3_218.CodeName3, r_Codes3_218.Notes, t_Sale_206.CodeID4, r_Codes4_219.CodeName4, r_Codes4_219.Notes, t_Sale_206.CodeID5, r_Codes5_220.CodeName5, r_Codes5_220.Notes

SELECT [CodeName1], [CodeName2], [GMSSourceGroup], SUM([SumMC]) AS [SumMC] FROM [AzTempDB].[CONST\maslov].[v_038_00979_1_CONST\maslov] GROUP BY [CodeName1], [CodeName2], [GMSSourceGroup]*/