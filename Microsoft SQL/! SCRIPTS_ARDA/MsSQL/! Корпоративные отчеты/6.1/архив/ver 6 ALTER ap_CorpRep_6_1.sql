...
DELETE FROM temp_corp_6_1 WHERE PartID = 22
...
SELECT 22 'PartID', 0 Style, 'Расходы дистрибьюций на проект' 'PartIDName', PGrID1, ROUND(SUM(SumMC),0) 'SumMC' FROM (
    ...
    FROM t_Est m WITH (NOLOCK) --t_Est	Переоценка цен прихода: Заголовок view: av_t_Est
        ...
        JOIN r_Codes4 rcd4 WITH (NOLOCK) ON (rcd4.CodeID4 = rpc.CodeID1)
    WHERE
...
INSERT INTO temp_corp_6_1 SELECT * FROM (
SELECT 7 'PartID', 0 Style,'ср. с/с 1 бут. ($)' 'PartIDName', r1.PGrID1, ROUND((r16.TOTALS / r1.TOTALS),2) 'TOTALS' FROM temp_corp_6_1 r16,temp_corp_6_1 r1 WHERE r16.PGrID1 = r1.PGrID1 AND r16.PartID = 5 and r1.PartID = 1
) AS m7
...
INSERT INTO temp_corp_6_1 SELECT * FROM (
SELECT 12 'PartID', 0 Style,'Прибыль от отгрузки' 'PartIDName', r2.PGrID1, ROUND((r2.TOTALS - r16.TOTALS),0) 'TOTALS' FROM temp_corp_6_1 r2,temp_corp_6_1 r16 WHERE r2.PGrID1 = r16.PGrID1 AND r2.PartID = 2 and r16.PartID = 5
) AS m4
...
INSERT INTO temp_corp_6_1 SELECT * FROM (
SELECT 18 'PartID', 0 Style,'Операционная прибыль на 1 бут. (шт.)' 'PartIDName', r1.PGrID1, ROUND((r16.TOTALS / r1.TOTALS),2) 'TOTALS' FROM temp_corp_6_1 r16,temp_corp_6_1 r1 WHERE r16.PGrID1 = r1.PGrID1 AND r16.PartID = 16 and r1.PartID = 1
) AS m18
...
--к п.13 этому пункту вернемся позже..--INSERT INTO..
...
--к п.17 этому пункту вернемся позже..--INSERT INTO..
