...
--DELETE FROM temp_corp_6_1 WHERE PartID = 21
--21---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO temp_corp_6_1 SELECT * FROM (
SELECT 20 'PartID', 0 Style,'Чистая прибыль с учетом расходов общих отделов' 'PartIDName', r16.PGrID1, ROUND((r16.TOTALS - r18.TOTALS),0) 'TOTALS' FROM temp_corp_6_1 r16,temp_corp_6_1 r18 WHERE r16.PGrID1 = r18.PGrID1 AND r16.PartID = 16 and r18.PartID = 18
) AS m4
