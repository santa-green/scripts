USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_CreateMessage]    Script Date: 27.05.2021 17:04:17 ******/
SET ANSI_NULLS ON
GO
...
IF NOT (
	...
	SELECT 'Для данного предприятия для отправки документа ORDRSP (подтверждение заказа) поле "Погрузка/Ожидается" должно быть заполнено: дата (не меньше текущей) и время.'
    RETURN
END;
