USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_OP_SendXML_Velike_Puzo]    Script Date: 18.01.2021 11:17:33 ******/
SET ANSI_NULLS ON
GO
...
IF @Testing = 0 
    BEGIN
        ...
        SET @copy_recipients = 'pashkovv@const.dp.ua;rumyantsev@const.dp.ua;reznichenko@const.dp.ua;heavy@heavy.dp.ua'; 
    END;
IF @Testing = 1 
    BEGIN
