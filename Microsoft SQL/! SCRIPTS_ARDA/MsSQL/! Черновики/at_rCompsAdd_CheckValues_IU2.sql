USE [Elit]
GO
/****** Object:  Trigger [dbo].[at_rCompsAdd_CheckValues_IU]    Script Date: 01.12.2020 18:54:48 ******/
SET ANSI_NULLS ON
GO
...
--[ADDED] rkv0 '2020-12-01 18:55' добавил запрет на ввод нулевого значения в поле CompGrID2 (##RE-2495##).
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
IF UPDATE(CompAdd)
	--[ADDED] Maslov Oleg '2020-10-05 14:46:42.391' ##RE-1121## Добавил пользователя 'yaa6' (Юпик Анну Анатольевну (код сл. 7217)) в исключения.
	IF SUSER_SNAME() NOT IN ('gnv','ptv','aav2','ntg','goy','mim2','moa6','ntg2','sas13','kiv24','zua','hia3','pnv5','arv','bla3','dya5','pvv4','sev28','kgv5','bag3','pvi5','yaa6')
	BEGIN
