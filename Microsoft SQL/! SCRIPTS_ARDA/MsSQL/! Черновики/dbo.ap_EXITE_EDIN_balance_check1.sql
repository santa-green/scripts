--USE [Elit]
--GO
--/****** Object:  StoredProcedure [dbo].[ap_EXITE_EDIN_balance_check]    Script Date: 16.08.2021 13:53:36 ******/
--SET ANSI_NULLS ON
--GO
--SET QUOTED_IDENTIFIER ON
--GO
--ALTER procedure [dbo].[ap_EXITE_EDIN_balance_check]
--as
--begin
...
IF @update_count > 0
BEGIN
    DECLARE @message varchar(max) = '<p style="font-size: 14; color: gray"><i>[для администратора БД] <br> 
    ...
    <p> https://edo-v2.edi-n.com/app/#/service/personal/account/tariffs/purchases</p> </i></p>'
    ...
    EXEC msdb.dbo.sp_send_dbmail  
        ...
        @subject = 'Контроль использования документов в пакете EDI', 
        @body = @body, 
        @body_format = 'HTML', 
