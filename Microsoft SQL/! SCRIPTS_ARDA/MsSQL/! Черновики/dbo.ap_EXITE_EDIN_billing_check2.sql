USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_EDIN_billing_check]    Script Date: 16.08.2021 16:38:28 ******/
SET ANSI_NULLS ON
GO
...
--За эти доки платит сеть:
--ORDER – заказ.
--RECADV – уведомление о приеме.
--RETANN – уведомление о возврате.
--RETINS – инструкция о возврате.
--CONDRA – универсальный документ.
--INSDES – инструкция по доставке.
