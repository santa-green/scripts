--USE [Elit_TEST]
--GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_ExportDoc]    Script Date: 11.01.2021 10:07:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
alter PROC [dbo].[ap_EXITE_ExportDoc_PUZO] @DocType VARCHAR(20), @DocCode INT = 11012, @ChID INT, @Out XML OUT, @TOKEN INT OUT
...
DECLARE @xml XML, @token INT;EXEC ap_EXITE_ExportDoc @DocType='COMDOC_ROZETKA', @DocCode=11012, @ChID=200434564,  @Out = @xml OUTPUT, @TOKEN = @token OUTPUT; SELECT @token, @xml;
*/
