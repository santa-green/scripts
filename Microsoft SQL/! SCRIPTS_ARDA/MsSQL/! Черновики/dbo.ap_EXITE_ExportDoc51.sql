USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_ExportDoc]    Script Date: 04.03.2021 17:56:02 ******/
SET ANSI_NULLS ON
GO
...
DECLARE @xml XML, @token INT;EXEC ap_EXITE_ExportDoc @DocType='DESADV', @DocCode=11012, @ChID=200445987,  @Out = @xml OUTPUT, @TOKEN = @token OUTPUT; SELECT @token, @xml;
