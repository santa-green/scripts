USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_ExportDoc]    Script Date: 31.05.2021 10:53:58 ******/
SET ANSI_NULLS ON
GO
...
DECLARE @xml XML, @token INT;EXEC ap_EXITE_ExportDoc @DocType='DESADV', @DocCode=11012, @ChID=200503863,  @Out = @xml OUTPUT, @TOKEN = @token OUTPUT; SELECT @token, @xml;
