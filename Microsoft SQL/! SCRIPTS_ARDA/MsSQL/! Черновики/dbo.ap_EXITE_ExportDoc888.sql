USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_ExportDoc]    Script Date: 24.03.2021 11:22:22 ******/
SET ANSI_NULLS ON
GO
...
/*
DECLARE @xml XML, @token INT;EXEC ap_EXITE_ExportDoc @DocType='CONTRL', @DocCode=11012, @ChID=200481684,  @Out = @xml OUTPUT, @TOKEN = @token OUTPUT; SELECT @token, @xml;
*/
