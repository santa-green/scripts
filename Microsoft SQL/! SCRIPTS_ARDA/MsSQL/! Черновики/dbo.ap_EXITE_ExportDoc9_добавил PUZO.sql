USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_EXITE_ExportDoc]    Script Date: 16.01.2021 16:30:06 ******/
SET ANSI_NULLS ON
GO
    ...
    , (SELECT 
        ...
        , COALESCE(irx.XMLData.value('(./HEAD/SENDER)[1]', 'VARCHAR(13)'), irx.XMLData.value('(./ORDER/HEAD/SENDER)[1]', 'VARCHAR(13)')) AS 'RECIPIENT' --GLN одержувача повідомлення
            ...
            , (SELECT 
                ...
                ,'1' /*пока хардкодим, нужны допполя в РН*/ AS 'PACKAGEQUANTITY' --Кількість упаковок
