ALTER PROC [dbo].[ap_EXITE_TaxDoc_new_declar] @ChID INT, @DocCode INT = 0, @IsConsolidated BIT = 0, @Out XML OUT
AS
BEGIN
  /*
  DECLARE @Out XML; EXEC [dbo].[ap_EXITE_TaxDoc_new_declar] @ChID = 200427900, @DocCode = 11012, @IsConsolidated = 0, @Out = @Out OUT; SELECT @Out 
  */
  SET NOCOUNT ON
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  /*INFO*/
