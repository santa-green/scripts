USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_OP_SendXML_Velike_Puzo]    Script Date: 14.06.2021 10:20:54 ******/
SET ANSI_NULLS ON
GO
...
--[CHANGED] rkv0 '2021-06-14 10:21' удалил адрес muharenko_sv@sheree.dp.ua, вместо него добавил garkusha_oa@sheree.dp.ua.
...
IF @Testing = 0 
    BEGIN
        ...
        --[ADDED] rkv0 '2021-05-19 10:24' добавил адрес muharenko_sv@sheree.dp.ua по заявке №7544.
        --[CHANGED] rkv0 '2021-06-14 10:21' удалил адрес muharenko_sv@sheree.dp.ua, вместо него добавил garkusha_oa@sheree.dp.ua.
        SET @copy_recipients = 'pashkovv@const.dp.ua;rumyantsev@const.dp.ua;reznichenko@const.dp.ua;heavy@heavy.dp.ua;garkusha_oa@sheree.dp.ua'; 
    END;
IF @Testing = 1 
    BEGIN
