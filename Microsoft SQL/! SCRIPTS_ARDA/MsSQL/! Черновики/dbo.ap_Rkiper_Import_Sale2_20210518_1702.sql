USE [ElitR]
GO
/****** Object:  StoredProcedure [dbo].[ap_Rkiper_Import_Sale]    Script Date: 18.05.2021 15:23:57 ******/
SET ANSI_NULLS ON
GO
...
--#region новые чеки из кипера t_Sale_R (с учетом фильтра)
	...
	SELECT *
	FROM #CHECKNUM
--#endregion новые чеки из кипера t_Sale_R (с учетом фильтра)
