USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_SendEmailEDI]    Script Date: 23.03.2021 14:55:54 ******/
SET ANSI_NULLS ON
GO
...
--[REMOVED] '2021-03-23 18:29' rkv0 закомментил блок в виду его ненадобности (документ CONTRL отправляется автоматом).
