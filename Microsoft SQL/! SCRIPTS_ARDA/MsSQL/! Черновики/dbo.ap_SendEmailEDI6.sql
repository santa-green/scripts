USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_SendEmailEDI]    Script Date: 09.12.2020 10:46:22 ******/
SET ANSI_NULLS ON
GO
...
-- [ADDED] rkv0 '2020-12-09 12:16' добавляю дополнительную инфо об отвязанных кодах; сеть Розетка (заявка #2984).
...
/*
update TOP(1) [S-PPC.CONST.ALEF.UA].Alef_Elit.dbo.at_EDI_reg_files set [status] = 3 WHERE chid = 72644 and doctype = 24000 and id = 'РОЗ01084280'
SELECT * FROM  [S-PPC.CONST.ALEF.UA].Alef_Elit.dbo.at_EDI_reg_files WHERE doctype = 24000 and id = 'РОЗ01084280' and chid = 72644 ORDER BY lastupdatedata DESC
SELECT * FROM  [S-PPC.CONST.ALEF.UA].Alef_Elit.dbo.at_EDI_reg_files WHERE doctype = 24000 and id = 'РОЗ01097216' and chid = 72629 ORDER BY lastupdatedata DESC
