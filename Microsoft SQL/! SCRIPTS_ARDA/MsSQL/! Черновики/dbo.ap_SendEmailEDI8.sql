USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_SendEmailEDI]    Script Date: 09.12.2020 15:37:10 ******/
SET ANSI_NULLS ON
GO
...
SELECT * FROM  [S-PPC.CONST.ALEF.UA].Alef_Elit.dbo.at_EDI_reg_files WHERE doctype = 24000 and id = 'РОЗ01088864' /*and chid = 72644*/ ORDER BY lastupdatedata DESC
