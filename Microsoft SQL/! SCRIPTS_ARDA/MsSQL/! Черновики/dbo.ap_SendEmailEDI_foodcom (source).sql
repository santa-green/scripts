USE [Elit]
GO
/****** Object:  StoredProcedure [dbo].[ap_SendEmailEDI]    Script Date: 22.04.2021 16:08:10 ******/
SET ANSI_NULLS ON
GO
...
--EXEC [dbo].[ap_SendEmailEDI] @doctype = 70121
    ...
    SET @subject = 'TEST_Новая возвратная накладная в EDI по Фудком'
    SET @rec = 'rumyantsev@const.dp.ua'
