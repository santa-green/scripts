...
/*
update TOP(1) [S-PPC.CONST.ALEF.UA].Alef_Elit.dbo.at_EDI_reg_files set [status] = 3 WHERE chid = 72629 and doctype = 24000 and id = 'РОЗ01097216'
...
-- [ADDED] rkv0 '2020-12-08 20:05' добавил детализацию по товарам к основному уведомлению (Танцюра #2887).
            ...
            <tr>
                <th><font color=" #0023ff "> RECADV </font></th>
