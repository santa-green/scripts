--последнее изменение в скрипте Pashkovv '2020-04-03 14:37:21.873'
...
/*
SELECT * FROM [S-SQL-D4].Elit.dbo.at_gln where GLN in ('9864066980598')

SELECT * FROM [S-SQL-D4].Elit.dbo.r_CompValues where VarName = 'BASE_GLN' and CompID = 72165
...
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (7060,'BASE_GLN','4820038509612')
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (65867,'BASE_GLN','9864066918782')
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (7117,'BASE_GLN','4820123566124')
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (66559,'BASE_GLN','9864066980598')
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (7156,'BASE_GLN','9864232359616')
insert [S-SQL-D4].Elit.dbo.r_CompValues (CompID, VarName, VarValue) Values (71711,'BASE_GLN','9864232350330')
*/
...
--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
) --номер предприятия
...
select  * from [S-SQL-D4].Elit.dbo.r_CompsAdd p2 where compid in (7031) and CompAdd like '%Балицкая%'
select  * from [S-SQL-D4].Elit.dbo.r_CompsAdd p2 where CompAdd like '%Балицкая%'
...
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '4820038509209' where compid = 7060 and CompAddID = 117
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '4820038509278' where compid = 7060 and CompAddID = 119
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '4820038508998' where compid = 7060 and CompAddID = 115
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '4820038508172' where compid = 7060 and CompAddID = 118
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232339465' where compid = 7031 and CompAddID = 63
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232350330' where compid = 72165 and CompAddID = 1
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232354420' where compid = 65867 and CompAddID = 27
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232352679' where compid = 7117 and CompAddID = 43
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864066996605' where compid = 66559 and CompAddID = 1
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232356936' where compid = 71527 and CompAddID = 7
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232357063' where compid = 7031 and CompAddID = 65
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232358497' where compid = 71527 and CompAddID = 8
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232357346' where compid = 71521 and CompAddID = 1
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232357070' where compid = 7031 and CompAddID = 66
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232280248' where compid = 7156 and CompAddID = 1
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232265757' where compid = 7065 and CompAddID = 5
UPDATE [S-SQL-D4].Elit.dbo.r_CompsAdd set GLNCode = '9864232348061' where compid = 71711 and CompAddID = 1
*/
...
BEGIN
	...
	--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
    ,(SELECT CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues WITH (NOLOCK) where VarName = 'BASE_GLN' and VarValue = (select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)) and compid != 72165 ) ZEC_KOD_KLN_OT
...
-- [ADDED] '2020-03-25 14:44' rkv0 добавлен киевский склад №30 (не нацсети) для Легиона
        ...
        case 
            when ISNULL((select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)),0) = '9864066918782' then 30 --склад общий Киев
            -- [ADDED] '2020-04-24 10:10' rkv0 добавлен харьковский склад для Гведеон/Семья.
            when ISNULL((select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)),0) = '9864066980598' then 11 --склад общий Харьков (Гведеон/Семья)
            -- [ADDED] '2020-04-28 14:17' rkv0 добавлен киевский склад для Ридо Групп (Пчелка).
            when ISNULL((select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)),0) = '9864232279860' then 30 --склад общий Киев
        end
     end ZEC_KOD_SKLAD_OT
	,1 ZEC_STATUS

    SELECT * FROM ALEF_EDI_GLN_OT WHERE ZEC_KOD_BASE = 9864232350330
    SELECT * FROM ALEF_EDI_GLN_OT WHERE ZEC_KOD_KLN_OT = 72165
...
INSERT dbo.ALEF_EDI_GLN_OT
    ...
    --) ZEC_KOD_KLN_OT
	--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
      and compid != 72165  ) ZEC_KOD_KLN_OT
	,(select CompAddID from [S-SQL-D4].Elit.dbo.r_CompsAdd WITH (NOLOCK) WHERE GLNCode = (select top 1 ZEO_ZEC_ADD from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N))
	  and CompID = (SELECT top 1 CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues p where p.VarName = 'BASE_GLN' and p.VarValue = 
		(select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N))	
        --)
...
-- [ADDED] '2020-03-25 14:44' rkv0 добавлен ID сети 998 (Легион)
	,case when (SELECT CodeID2 FROM [S-SQL-D4].Elit.dbo.r_Comps p2 WITH (NOLOCK) where compid = 
		(SELECT CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues WITH (NOLOCK) where VarName = 'BASE_GLN' and VarValue = (select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N))
        --)
      	--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
        AND COMPID != 72165)
	...
	else (SELECT CodeID2 FROM [S-SQL-D4].Elit.dbo.r_Comps p2 WITH (NOLOCK) where compid = 
		(SELECT CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues WITH (NOLOCK) where VarName = 'BASE_GLN' and VarValue = (select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N))
                --)
      	--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
        AND COMPID != 72165)
	)
	end EGS_GLN_SETI_ID -- ищем в справочнике предприятий на вкладке Дополнительно поле Код признака 2
	,null EGS_STATUS
	UNION ALL
  SELECT
...
--		(SELECT CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues WITH (NOLOCK) where VarName = 'BASE_GLN' and VarValue = (select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)))
--		)
SELECT EGS_GLN_ID FROM dbo.ALEF_EDI_GLN_SETI WITH (NOLOCK) where EGS_GLN_SETI_ID = (SELECT CASE WHEN (SELECT CodeID2 FROM [S-SQL-D4].Elit.dbo.r_Comps p2 WITH (NOLOCK) where compid = 
		(SELECT CompID FROM [S-SQL-D4].Elit.dbo.r_CompValues WITH (NOLOCK) where VarName = 'BASE_GLN' and VarValue = (select top 1 ZEO_ZEC_BASE from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N))
                --)
      	--AND COMPID != 72165 --rkv0 '2020-06-26 13:42' ИСКЛЮЧЕНИЕ: для ОККО-Драйв (2 предприятия: Львов 72165, Киев 71711, а GLN один).
        AND COMPID != 72165)
...
SELECT * FROM ALEF_EDI_GLN_SETI WHERE EGS_GLN_SETI_ID = 624
SELECT * FROM ALEF_EDI_GLN_SETI WHERE EGS_GLN_ID IN (9864232348061,9864232350330)
...
IF NOT EXISTS (SELECT CompID,GLNCode,count(*) 'dubli' FROM  [S-SQL-D4].Elit.dbo.r_CompsAdd where GLNCode <> '' group by CompID,GLNCode having count(*) > 1) SELECT 'SUCCESS - Дубликатов нет.'
    ELSE SELECT CompID,GLNCode,count(*) 'dubli' FROM  [S-SQL-D4].Elit.dbo.r_CompsAdd where GLNCode <> '' group by CompID,GLNCode having count(*) > 1

/*
--дубли внутри опредприятия по GLN in Elit
SELECT CompID,GLNCode,count(*) dubli FROM  [S-SQL-D4].Elit.dbo.r_CompsAdd where GLNCode <> '' group by CompID,GLNCode having count(*) > 1

SELECT GLNCode,count(*) dubli FROM  [S-SQL-D4].Elit.dbo.r_CompsAdd where GLNCode <> '' group by GLNCode having count(*) > 1

SELECT ZEC_KOD_BASE,ZEC_KOD_ADD, count(*) dubli FROM ALEF_EDI_GLN_OT WHERE len(ZEC_KOD_ADD) > 6 group by ZEC_KOD_BASE,ZEC_KOD_ADD having count(*) > 1

SELECT GLN, count(*) dubli FROM [S-SQL-D4].Elit.dbo.at_gln WHERE len(GLN) > 6 group by GLN having count(*) > 1

SELECT * FROM [S-SQL-D4].Elit.dbo.at_gln where GLN = '4820117889918'
SELECT * FROM  [S-SQL-D4].Elit.dbo.r_CompsAdd where GLNCode = '4820117889918' 
SELECT * FROM ALEF_EDI_GLN_SETI WHERE EGS_GLN_ID = '4820117889918'
SELECT * FROM ALEF_EDI_GLN_OT WHERE ZEC_KOD_BASE = '4820117889918'
SELECT * FROM ALEF_EDI_GLN_OT WHERE ZEC_KOD_ADD = '4820117889918'

SELECT CodeID2 FROM [S-SQL-D4].Elit.dbo.r_Comps p2 WITH (NOLOCK) where compid = 7117
select * from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = (SELECT ORDER_NUMBER FROM #N)
select * from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ORDER_NUMBER = '9278-4430105'
select * from dbo.ALEF_EDI_ORDERS_2 WITH (NOLOCK) where ZEO_ZEC_BASE = '4820038509612' ORDER BY 3 desc


SELECT * FROM ALEF_EDI_GLN_SETI WHERE EGS_GLN_NAME like '%новус%' --EGS_GLN_ID = '9864060910836'
SELECT * FROM ALEF_EDI_GLN_SETI WHERE EGS_GLN_SETI_ID = 630 --621 новус
