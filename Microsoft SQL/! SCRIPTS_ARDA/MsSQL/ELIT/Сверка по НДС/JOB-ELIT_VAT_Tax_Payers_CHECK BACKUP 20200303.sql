...
/****** Object:  Job [ELIT_VAT_Tax_Payers_CHECK]    Script Date: 03.03.2020 11:09:24 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 03.03.2020 11:09:24 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ELIT_VAT_Tax_Payers_CHECK', 
		@enabled=1, 
		...
		@owner_login_name=N'CONST\rumyantsev', 
		@notify_email_operator_name=N'support_arda', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Загрузка и извлечение реестра pdv.csv]    Script Date: 03.03.2020 11:09:24 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Загрузка и извлечение реестра pdv.csv', 
		@step_id=1, 
		...
		@command=N'Exec XP_CMDSHELL ''E:\OT38ElitServer\Campary_Export\CamparyDnepr\pdv_reestr.bat''', 
		@database_name=N'Elit', 
		@flags=20
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Сверка реестра с базой]    Script Date: 03.03.2020 11:09:24 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Сверка реестра с базой', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
...
SELECT TaxPayer, CompType, Code, TaxCode, CompID, CompName, CompShort, CompGrID2, t.kod_pdv, t.dat_reestr, t.dat_anul, t.[name] FROM r_comps rc
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Ежедневно 09:00', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_date=20200228, 
		@active_end_date=99991231, 
		@active_start_time=80000, 
		@active_end_time=235959, 
		@schedule_uid=N'd40920a2-7f5c-4857-91b9-2a3d3c854d74'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
