...
-- [ADDED] '2020-03-05 15:53' rvk0 добавил RowID
        ALTER TABLE tempdb..Elit_VAT_log ADD RowID uniqueidentifier NOT NULL DEFAULT NEWSEQUENTIALID() --NEWSEQUENTIALID https://docs.microsoft.com/en-us/sql/t-sql/functions/newsequentialid-transact-sql?view=sql-server-ver15
        
    END;
INSERT INTO tempdb..Elit_VAT_log ([name], kod_pdv, dat_reestr, dat_anul, c_anul, c_oper, d_reestr_sg, kved, d_anul_sg, d_pdv_sg)
SELECT * FROM (
    SELECT [name], kod_pdv, dat_reestr, dat_anul, c_anul, c_oper, d_reestr_sg, kved, d_anul_sg, d_pdv_sg FROM #temp
    EXCEPT
