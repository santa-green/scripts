...
update m2 set TAB1_A13 = 'Коньяк Агмарті 3 роки 40%  0,5*12' from ElitDistr.dbo.at_t_Medoc m2 where m2.N11 = '2020.08.28' and m2.N2_11 =  28116 and m2.TAB1_A13 = 'Коньяк Агмарті 3 роки 40% 0,5*12'
update m2 set TAB1_A13 = 'Коньяк Агмарті 3 роки 40%  0,5*12' from ElitDistr.dbo.at_t_Medoc m2 where m2.N11 = '2020.08.28' and m2.N2_11 =  28089 and m2.TAB1_A13 = 'Коньяк Агмарті 3 роки 40% 0,5*12'
...
update mr set TAB1_A3 = 'Коньяк Агмарті 3 роки 40%  0,5*12' from ElitDistr.dbo.at_t_Medoc_RET mr where mr.N2 = '2020.08.07' and mr.N2_11 =  7047 and mr.TAB1_A3 = 'Коньяк Агмарті 3 роки 40% 0,5*12'
update mr set TAB1_A3 = 'Коньяк Агмарті 3 роки 40%  0,5*12' from ElitDistr.dbo.at_t_Medoc_RET mr where mr.N2 = '2020.08.14' and mr.N2_11 =  14063 and mr.TAB1_A3 = 'Коньяк Агмарті 3 роки 40% 0,5*12'
update mr set TAB1_A3 = 'Коньяк Агмарті 3 роки 40%  0,5*12' from ElitDistr.dbo.at_t_Medoc_RET mr where mr.N2 = '2020.07.31' and mr.N2_11 =  31080 and mr.TAB1_A3 = 'Коньяк Агмарті 3 роки 40% 0,5*12'
...
SELECT * FROM ElitR.dbo.r_Prods where UAProdName like '%&A N%' or Notes like '%&A N%' 
SELECT * FROM ElitDistr.dbo.r_Prods where  Notes like '%&A N%' 
SELECT * FROM ElitDistr.dbo.r_Prods where  UM like '%набір%' 


SELECT * FROM Elit.dbo.r_ProdEC ec 
where ISNUMERIC(ExtProdID) = 1 and ec.CompID = 10797 
and cast(ExtProdID as bigint) in (SELECT ProdID FROM ElitR.dbo.r_Prods where UAProdName like '%&A N%' or Notes like '%&A N%')
...
and ec.ExtProdID in (600721)
ORDER BY 1,2

ProdID_ElitR	ProdID_Elit
600721	28296
600721	30630
600721	31629
600721	32101
