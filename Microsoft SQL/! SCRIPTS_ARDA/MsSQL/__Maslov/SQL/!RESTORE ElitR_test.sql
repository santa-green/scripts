--  Восстановить базу ElitR_test из бекапа
  ...
  DECLARE @BkpFileName varchar(MAX)='E:\OT38ElitServer\Import\Backup\Elit_backup_2019-03-13_14-23-11.bak'
  DECLARE @DBName sysname = 'Elit_TEST_IM2' -- 
...
/*
  --выбросить пользователей из  базы
    ...
    DECLARE @SPID int, @Cmd varchar(8000), @db_name varchar(250) = 'Elit_TEST_IM2'
