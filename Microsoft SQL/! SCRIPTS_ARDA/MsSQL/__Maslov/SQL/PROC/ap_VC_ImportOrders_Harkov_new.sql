...
--moa0 '2019-09-30 18:12:54.289' Возникла ошибка, при которой в ЗВР нет позиции с товаром, а в t_SaleTempD - есть
--(t_SaleTempD это то, что будет на кассе). Теперь, если на остатках нет товара, то записи во временную таблицу не будет.
