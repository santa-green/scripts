...
BEGIN
	...
	DECLARE @LocalPath varchar(MAX)='E:\OT38ElitServer\Import'
...
DECLARE @DocDate SMALLDATETIME = '2018-08-28' --дата РДЦП (один раз в месяц, первый день месяца )
...
BEGIN
	...
	BEGIN
		...
		SET @Notes = 'создано скриптом: Перенос остатков на новые коды.sql.sql'
