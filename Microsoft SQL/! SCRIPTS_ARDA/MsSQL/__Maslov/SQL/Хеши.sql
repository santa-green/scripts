...
DECLARE @UserName NVARCHAR(50) = 'svd2' --пользователь svd2 0x0100105df8d5c0a844f97971e01c6cb60216e2f7fb10d0830d8c
...
DECLARE @UserName nvarchar(50) = 'svd2' --пользователь
DECLARE @PWD nvarchar(max)


SET @PWD = '0x0100105df8d5c0a844f97971e01c6cb60216e2f7fb10d0830d8c' --вставить хэш --( 0x0100fc1bc3a04bd52946002fac7fcac792c1be38c676f6c6adbd ) для пароля smeniparol
