...
UPDATE r_ProdMQ
SET Notes = '21' + CONVERT (VARCHAR, ProdID)
WHERE BarCode LIKE '21%' AND LEN (BarCode) = 7 AND PLID = 0 AND ProdID BETWEEN 10000 AND 99999

UPDATE r_ProdMQ
SET Notes = '210' + CONVERT (VARCHAR, ProdID)
WHERE BarCode LIKE '21%' AND LEN (BarCode) = 7 AND PLID = 0 AND ProdID BETWEEN 1000 AND 9999
