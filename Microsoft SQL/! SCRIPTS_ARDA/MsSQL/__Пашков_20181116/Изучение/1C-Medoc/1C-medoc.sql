...
--,* 
 INTO #Medoc	
FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', N'Excel 12.0; IMEX=1; Database=\\s-sql-d4\OT38ElitServer\Import\1C-Medoc\J1201008_TAB1.xlsx' , 'select * from [Лист1$]') as ex;
