...
where r.DocDate Between Cast ('20160601' as SMALLDATETIME) and Cast ('20160630' as SMALLDATETIME) and c.CurrID=980 and r.Ourid in (7,8,9,12) and r.CodeID1 in (82,87,100,2004)
