...
DECLARE @BDate SMALLDATETIME = '20180901' --дата начала смены курса
DECLARE @EDate SMALLDATETIME = '20180930' --дата конца смены курса
DECLARE @Old_KursMC numeric(21,9) = 27.00 -- новый курс доллара
