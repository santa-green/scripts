...
/* Добавлен параметр IsFiscal (по умолчанию true - для вызова процедуры из ТК в момент сверки )*/
  ...
  SET @Time = '2016-12-09 21:40:06.163'--GetDate()
  SELECT @LastZRep =  '2016-12-08 22:40:06.163'--ISNULL((SELECT TOP 1 DocTime FROM t_zRep WHERE CRID = @CRID ORDER BY DocTime DESC), '1900-01-01 00:00:00')
