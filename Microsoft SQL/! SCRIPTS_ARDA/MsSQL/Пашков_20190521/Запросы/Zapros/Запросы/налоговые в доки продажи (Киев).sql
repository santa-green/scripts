...
from t_Sale 
where DocDate = @date  and stockid in ( 1221 , 1222 ,1225)


select docdate , stockid , TaxDocID
from t_Sale 
where DocDate  between  '20131221' and '20131231' and stockid in ( 1221 , 1222,1225)
...
where DocDate = '20131231' 


update t_CRRet
set t_CRRet.TaxDocID = 573
from t_CRRet 
where DocDate = '20131231' and StockID = 1221
