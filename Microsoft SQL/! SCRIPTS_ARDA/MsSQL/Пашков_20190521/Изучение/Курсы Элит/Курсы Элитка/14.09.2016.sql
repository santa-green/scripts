...
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (40,41,81,82,87,90,95,100,2004)
Rollback
...
From t_Ret d 
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160930' as SMALLDATETIME) and d.KursMC=26.00
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (63,2032)
Rollback
...
From t_Inv d 
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160930' as SMALLDATETIME) and d.KursMC=26.00
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (63,71)
Rollback
...
From t_Exp d 
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160930' as SMALLDATETIME) and d.KursMC=26.00
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (0,30,36,50,2004,2011,2022,2032,2035,2037,2038)
Rollback
...
From t_Epp d 
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160930' as SMALLDATETIME) and d.KursMC=26.00
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (24,40,63,79,100,2004,2026,2037)
Rollback
...
set d.KursMC =27.00
From t_IOExp d 
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160901' as SMALLDATETIME) and d.KursMC=26.00
...
where r.DocDate > '20160831' and c.CurrID=2 and r.Ourid in (1,2,3,4,5,10,11) and r.CodeID1 in (81,82,87,90,95,100,2004)
...
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (2004,2011,2022,2032,2035,2037,2038)
...
where DocDate Between Cast ('20160901' as SMALLDATETIME) and Cast ('20160930' as SMALLDATETIME) and d.KursMC=26.00
and d.OurID in (1,2,3,4,5,10,11) and d.CodeID1 in (2004,2026,2037)
Rollback
