--запрос по логистике версия 6 от 15.08.2018 10:00
...
FROM (		
	...
	FROM (
		...
		Остаток_на_ЦС_бр, Резерв_на_ЦС, Остаток220_бр,Резерв220, Остаток218_бр, Резерв218, Остаток, Расход,Расход220320, kof 
		...
		FROM ( 
			...
			SELECT gr.ProdID,  ISNULL(gr.SumQty_AccQty,0) 'Остаток_на_ЦС_бр', p.PCatID, r_ProdC.PCatName, p.ProdName, p.PGrID1, r_ProdG1.PGrName1 , isnull(mq.Qty,1) 'Кол_в_ящике',
