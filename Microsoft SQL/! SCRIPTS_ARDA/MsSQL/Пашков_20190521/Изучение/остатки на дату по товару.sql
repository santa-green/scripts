...
Declare @BDate smalldatetime, @EDate smalldatetime --= '2016-12-31'

Declare @ProdID int = 801379
...
/*
SELECT * FROM r_Prods Where r_Prods.InRems = 0 AND r_Prods.ProdID  = 801379  
SELECT InRems,* FROM r_Prods Where r_Prods.ProdID  = 801379  
