...
SELECT  '0 - dbo.af_GetSpecSubs(6, 1257, 1257, ''2018-01-16'' , 603752, 7)'   
...
SELECT @ChID ChID ,	@OurID OurID,  @DocID DocID, @Notes Notes
 ...
 SELECT  '0.1 - dbo.af_GetSpecSubs(6, 1257, 1257, ''2018-01-16'' , 603752, 7)'   
SELECT * FROM dbo.af_GetSpecSubs(6, 1257, 1257, '2018-01-16' , 603752, 7)
...
SELECT @AChID AChID     
 ...
 SELECT  '0.2 - dbo.af_GetSpecSubs(6, 1257, 1257, ''2018-01-16'' , 603752, 7)'   
SELECT * FROM dbo.af_GetSpecSubs(6, 1257, 1257, '2018-01-16' , 603752, 7)
SELECT dbo.tf_GetRemTotal(6, 1257, 1, 603752) rem_603752
...
SELECT * FROM t_SRecA WHERE AChID = @AChID ORDER BY 1   
 ...
 SELECT  '0.3 - dbo.af_GetSpecSubs(6, 1257, 1257, ''2018-01-16'' , 603752, 7)'   
SELECT * FROM dbo.af_GetSpecSubs(6, 1257, 1257, '2018-01-16' , 603752, 7)
SELECT dbo.tf_GetRemTotal(6, 1257, 1, 603752) rem_603752
...
SELECT  '1 - dbo.af_GetSpecSubs(@OurID, @StockID, @SubStockID, @EDate , @ProdID, @Qty)'   
SELECT * FROM dbo.af_GetSpecSubs(@OurID, @StockID, @SubStockID, @EDate , @ProdID, @Qty)          
SELECT  '1 - dbo.af_GetSpecSubs(6, 1257, 1257, ''2018-01-16'' , 603752, 7)'   
SELECT * FROM dbo.af_GetSpecSubs(6, 1257, 1257, '2018-01-16' , 603752, 7)
