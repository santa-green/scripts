...
, (select TableName from z_Tables s WHERE s.TableCode= z.TableCode) 
, (select Tabledesc from z_Tables s WHERE s.TableCode= z.TableCode) 
FROM z_ReplicaTables z where ReplicaPubCode in (1200000000,12)
ORDER BY 2
...
--1700010000
SELECT top 10000 * FROM [192.168.42.6].FFood601.dbo.t_MonRec  where chid between 1700000000 and 1799999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 1700000000 and 1799999999 ORDER BY chid desc

--1600010483
SELECT top 10000 * FROM [192.168.174.38].ElitRTS220.dbo.t_MonRec  where chid between 1600000000 and 1699999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 1600000000 and 1699999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 1500000000 and 1599999999 ORDER BY chid desc

--ok
SELECT top 10000 * FROM [192.168.174.30].ElitRTS201.dbo.t_MonRec  where chid between 800000000 and 899999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 800000000 and 899999999 ORDER BY chid desc

--1100001000
SELECT top 10000 * FROM  [192.168.157.22].ElitRTS302.dbo.t_MonRec  where chid between 1100000000 and 1199999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 1100000000 and 1199999999 ORDER BY chid desc

--
SELECT top 10000 * FROM  [s-marketa3].ElitRTS301.dbo.t_MonRec   where chid between 900000000 and 999999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 900000000 and 990000000 ORDER BY chid desc

SELECT top 10000 * FROM  [s-marketa4].ElitRTS181.dbo.t_MonRec  where chid between 1200000000 and 1299999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 1200000000 and 1299999999 ORDER BY chid desc

SELECT top 10000 * FROM  [s-marketa].elitv_dp.dbo.t_MonRec  where chid between 100000000 and 199999999 ORDER BY chid desc
SELECT top 100000 * FROM t_MonRec where chid between 100000000 and 199999999 ORDER BY chid desc



SELECT top 100000 * FROM elitR_test.dbo.t_MonRec where chid between 900000000 and 990000000 ORDER BY chid desc

SELECT top 100000 * FROM elitR_test.dbo.t_MonRec where DocID in (900001725)

SELECT top 100000 * FROM t_MonRec where DocID in (900001725)
SELECT top 100000 * FROM t_MonRec where chid < 0

SELECT top 100000 * FROM t_MonRec where chid in (
SELECT top 10000 DocID FROM  [s-marketa3].ElitRTS301.dbo.t_MonRec   where chid between 900000000 and 990000000 ORDER BY 1 
)
...
SELECT top 100000 * FROM z_LogCreate where TableCode = 11018001 
and chid between 1700000000 and 1799999999
ORDER BY ChID

SELECT top 100000 * FROM z_LogCreate where TableCode = 11018001 
and chid between 1600000000 and 1699999999
ORDER BY ChID

SELECT max(chid) FROM z_LogCreate where TableCode = 11018001 and chid between 1700000000 and 1799999999
SELECT max(chid) FROM t_MonRec where  chid between 1700000000 and 1799999999

SELECT max(chid) FROM z_LogCreate where TableCode = 11018001 and chid between 1600000000 and 1699999999
SELECT max(chid) FROM t_MonRec where  chid between 1600000000 and 1699999999

SELECT top 10000 * FROM  [192.168.157.22].ElitRTS302.dbo.t_sale  where chid = 1100036527
