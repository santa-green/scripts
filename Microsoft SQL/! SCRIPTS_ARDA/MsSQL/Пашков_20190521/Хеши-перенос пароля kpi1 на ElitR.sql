...
declare @ServerParent nvarchar(50) ='S-MARKETA' --откуда нужно перенести
declare @UserName nvarchar(50) = 'kpi1' --пользователь
...
declare @UserName nvarchar(50) = 'paa18' --пользователь
