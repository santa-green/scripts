...
# michael.jackson
# os.environ['AWS_ACCESS_KEY_ID'] = 'AKIATMYBHHBWKBCRTW6M'
# os.environ['AWS_SECRET_ACCESS_KEY'] = '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'
# root user
...
def lambda_handler():
    ...
    try:
        ...
        print("Snapshot creation and export task completed successfully.")
    ...
    # return {
    #     'statusCode': 200,
    #     'body': 'Snapshot creation and export completed.'
    # }
